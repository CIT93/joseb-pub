...
const renderTblBtn = (index, data) => {
  ...
  btnEdit.addEventListener("click", e => {
    ...
    FORM.wasteProduced.value = rowData.wasteProduced;
    FORM.glass.checked = rowData.recycle.glass;
    FORM.plastic.checked = rowData.recycle.plastic;
    FORM.steel.checked = rowData.recycle.steel;
